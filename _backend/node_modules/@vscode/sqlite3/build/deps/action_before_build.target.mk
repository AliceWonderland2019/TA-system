...
cmd_deps_sqlite3_gyp_action_before_build_target_unpack_sqlite_dep = LD_LIBRARY_PATH=$(builddir)/lib.host:$(builddir)/lib.target:$$LD_LIBRARY_PATH; export LD_LIBRARY_PATH; cd $(srcdir)/deps; mkdir -p $(obj)/gen/sqlite-autoconf-3360000; /opt/local/bin/python3 ./extract.py ./sqlite-autoconf-3360000.tar.gz "$(obj)/gen"
...
$(obj)/gen/sqlite-autoconf-3360000/sqlite3.c: export XCODE_VERSION_ACTUAL := 1321
